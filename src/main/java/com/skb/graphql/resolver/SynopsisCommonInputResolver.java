...
@DgsComponent
public class SynopsisCommonInputResolver {
	...
	public SynopsisCommonInputResolver(SmdApiService smdApiService, ScsApiService scsApiService, EuxpApiService euxpApiService) {
